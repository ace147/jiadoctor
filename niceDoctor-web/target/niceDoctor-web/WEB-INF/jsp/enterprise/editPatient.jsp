						...
						<div class="col-md-6">
							<form role="form" action="${ctx}/jybUser/addJybUser" method="post">
								...
								<div class="form-group">
									<label>账号</label>
									<input class="form-control" placeholder="Placeholder" name="account" value="${jybUser.account}">
								</div>
								<div class="form-group">
									<label>昵称</label>
									<input class="form-control" placeholder="Placeholder" name="nickname" value="${jybUser.nickname}">
								</div>
								<div class="form-group">
									<label>真实姓名</label>
									<input class="form-control" placeholder="Placeholder" name="realName" value="${jybUser.realName}">
								</div>
								<div class="form-group">
									<label>手机</label>
									<input class="form-control" placeholder="Placeholder" name="mobile" value="${jybUser.mobile}">
								</div>
							<!--	
							<div class="form-group">
